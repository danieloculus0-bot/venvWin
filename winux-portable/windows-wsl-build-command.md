...
```powershell
wsl bash -lc "cd /mnt/c/path/to/venvWin && chmod +x winux-portable/bootstrap-flash-ready-ubuntu.sh && ./winux-portable/bootstrap-flash-ready-ubuntu.sh"
```
...
```powershell
wsl bash -lc "cd /mnt/c/Users/Daniel/venvWin && chmod +x winux-portable/bootstrap-flash-ready-ubuntu.sh && ./winux-portable/bootstrap-flash-ready-ubuntu.sh"
```
