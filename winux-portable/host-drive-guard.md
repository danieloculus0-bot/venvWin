# WinUx Portable Host Drive Guard
...
WinUx Portable should default to:
...
The file manager may show host drives, but WinUx should not silently use them for capsule storage.
...
```bash
winux host-guard status
winux host-guard strict
winux host-guard relaxed
```
