...
WinUx Portable is the first shippable product target for venvWin.
...
This folder is for WinUx Portable build scripts, image configuration, branding assets, boot notes, and packaging docs.
