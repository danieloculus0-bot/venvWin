...
$cmd = "cd '$wslPath' && chmod +x winux-portable/bootstrap-flash-ready-ubuntu.sh && ./winux-portable/bootstrap-flash-ready-ubuntu.sh"
wsl.exe bash -lc $cmd
...
Write-Host "Next: use winux-portable/usb-flash-guide.md before writing any USB drive."
