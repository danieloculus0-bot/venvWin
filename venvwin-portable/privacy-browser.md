# venvWin Portable Privacy Browser Plan

## Goal

venvWin Portable should include a privacy-focused browser path by default.
...
That makes fake privacy bullshit. venvWin should not promise what it cannot prove.
...
`venvwin doctor` or a future `venvwin doctor` should report:
