# venvWin Lightweight Old Hardware Target

venvWin Portable is intended to extend the usable life of older PCs, especially machines from around 2010 and newer that are too slow, unsupported, or annoying under modern Windows.
...
venvWin should feel closer to a useful old Puppy Linux / lightweight rescue OS than a modern full desktop distro.
...
- stores state in venvWin-owned portable storage
...
Storage: USB boot media plus optional VENVWINDATA storage
...
- launcher entry in the venvWin menu
...
venvWin may log, but logs should go to venvWin-owned storage or the live session, not the host OS disk.
