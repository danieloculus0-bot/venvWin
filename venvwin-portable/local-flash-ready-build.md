...
```bash
chmod +x venvwin-portable/audit-public-branding.sh venvwin-portable/pre-iso-readiness.sh
...
```bash
chmod +x venvwin-portable/audit-public-branding.sh venvwin-portable/pre-iso-readiness.sh venvwin-portable/build-iso.sh venvwin-portable/build-flash-ready-standard.sh
