...
```bash
VENVWIN_PROFILE=core ./venvwin-portable/build-iso.sh
VENVWIN_PROFILE=standard ./venvwin-portable/build-iso.sh
VENVWIN_PROFILE=privacy ./venvwin-portable/build-iso.sh
```
...
```bash
./venvwin-portable/test-iso-qemu.sh dist/venvwin-portable-alpha-standard.iso
```
